...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    // --- Accounting ---
    'accounting': 'المحاسبة',
    'accounting.coa.title': 'إدارة دليل الحسابات (شجرة الحسابات)',
    'accounting.coa.addAccount': 'إضافة حساب جديد',
    'accounting.coa.noAccounts': 'لا يوجد حسابات معرّفة',
    'accounting.coa.activateStandard': 'تفعيل دليل الحسابات القياسي',
    'accounting.coa.isGroup': 'حساب مجموعة؟ (Group Account)',
    'accounting.coa.groupHint': 'تفعيل هذا الخيار يسمح بإضافة حسابات فرعية تحته.',
    'accounting.coa.commitAccount': 'اعتماد الحساب',
    'accounting.journals.title': 'قيود اليومية',
    'accounting.journals.desc': 'تسجيل الحركات المالية المزدوجة المعتمدة',
    'accounting.journals.newEntry': 'قيد يدوي جديد',
    'accounting.journals.draftTitle': 'إعداد قيد يومية متوازن',
    'accounting.journals.lineMemo': 'شرح السطر',
    'accounting.journals.balanced': 'قيد متوازن',
    'accounting.journals.unbalanced': 'غير متوازن',
    'accounting.journals.postToLedger': 'ترحيل القيد للأستاذ العام',
    'accounting.vouchers.receiptTitle': 'سندات القبض',
    'accounting.vouchers.paymentTitle': 'سندات الصرف',
    'accounting.vouchers.issueReceipt': 'إصدار سند قبض ذكي',
    'accounting.vouchers.issuePayment': 'إصدار سند صرف ذكي',
    'accounting.vouchers.receivedFrom': 'يستلم من السيد / الجهة',
    'accounting.vouchers.paidTo': 'يصرف للسيد / الجهة',
    'accounting.vouchers.depositTo': 'يودع في حساب',
    'accounting.vouchers.payFrom': 'يصرف من حساب',
    'accounting.vouchers.againstAccount': 'مقابل حساب (الطرف المقابل)',
    'accounting.vouchers.autoRecon': 'المطابقة الآلية',
    'accounting.vouchers.autoReconHint': 'عند حفظ هذا السند، سيقوم النظام تلقائياً بتوليد قيد يومية مزدوج وترحيله للأستاذ العام.',
  ...
  en: {
    ...
    'accounting.coa.noAccounts': 'No accounts defined',
    'accounting.coa.activateStandard': 'Activate Standard COA',
    'accounting.coa.isGroup': 'Is it a Group?',
    'accounting.coa.groupHint': 'Enable to allow children accounts.',
    'accounting.coa.commitAccount': 'Commit Account',
    'accounting.journals.title': 'Journal Entries',
    'accounting.journals.desc': 'Record dual-entry financial transactions',
    'accounting.journals.newEntry': 'New Entry',
    'accounting.journals.draftTitle': 'Draft Balanced Entry',
    'accounting.journals.lineMemo': 'Memo',
    'accounting.journals.balanced': 'Balanced',
    'accounting.journals.unbalanced': 'Unbalanced',
    'accounting.journals.postToLedger': 'Post Entry to Ledger',
    ...
    'accounting.vouchers.autoReconHint': 'Posting will auto-generate journal entries.',
    ...
    'accounting.smartRecon': 'Smart Recon',
    ...
    'settings.checklists.desc': 'Manage references and paths',
    'settings.enterprise.desc': 'Manage enterprise preferences',
    'settings.configure': 'Configure',
    'settings.users.desc': 'Manage users and access',
    'settings.roles.desc': 'Manage roles matrix',
    'settings.workHours.desc': 'Set working hours',
    'settings.profile.desc': 'Personal account settings',
    'settings.templates.desc': 'Manage templates library',
