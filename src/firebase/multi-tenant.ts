...
export const paths = {
  ...
  subcontractors: (companyId: string) => getTenantPath(companyId, 'subcontractors'),
  ...
  subconContracts: (companyId: string) => getTenantPath(companyId, 'subconContracts'),
  ...
  fieldVisits: (companyId: string) => getTenantPath(companyId, 'fieldVisits'),
  ...
  subIpcs: (companyId: string) => getTenantPath(companyId, 'subIpcs'),
  ...
  costCenters: (companyId: string) => getTenantPath(companyId, 'costCenters'),
  profitCenters: (companyId: string) => getTenantPath(companyId, 'profitCenters'),
};
