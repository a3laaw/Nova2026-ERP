            ...
            <Card className="border-0 shadow-xl rounded-[2.5rem] bg-white ring-1 ring-black/5 overflow-hidden">
               <CardContent className="p-10 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                     ...
                     <div className="space-y-2">
                        <Label className="text-[10px] font-black uppercase text-slate-400">{isRtl ? 'كود المقياسة' : 'BOQ Code'}</Label>
                     ...
                     <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border-2 border-white shadow-inner">
                        <p className="text-[10px] font-black text-slate-400 uppercase">{t('defaultTemplate')}</p>
                       ...
                       <table className="w-full text-start text-sm">
                          <thead className="bg-slate-50 border-b">
                            <tr className="text-[10px] font-black uppercase text-slate-400 tracking-widest">
                              <th className="p-6 text-start">{isRtl ? 'توصيف العمل' : 'Description'}</th>
                              <th className="p-6 text-center w-24">{isRtl ? 'الوحدة' : 'Unit'}</th>
                              <th className="p-6 text-center w-24">{isRtl ? 'الكمية' : 'Qty'}</th>
                              <th className="p-6 text-center w-32">{isRtl ? 'السعر' : 'Rate'}</th>
