                  ...
                  <div className="p-8 rounded-[2rem] bg-orange-50 border-4 border-dashed border-primary/20 space-y-4 animate-in zoom-in-95">
                     <div className="flex items-center gap-4 text-primary">
                        ...
                        <div className="text-start">
                           ...
                           <p className="text-xs font-bold text-orange-800/70">{isRtl ? 'سيتم حصر اختيار المقايسات في المشروع بهذا القالب حصراً.' : 'Only this BOQ template will be available for contracts based on this template.'}</p>
                        </div>
                     </div>
                  ...
                  <div className="space-y-6">
                     <div className="flex justify-between items-center px-2">
                        ...
                        <Button variant="outline" size="sm" onClick={addMilestone} className="rounded-xl font-black text-[10px] border-2 h-10 px-8 gap-3 bg-white hover:bg-primary/5 shadow-md">
                           <Plus className="h-4 w-4 text-primary" /> {isRtl ? 'إضافة دفعة' : 'Add Payment'}
                        </Button>
                     </div>
                     ...
                     <div className="border-2 border-slate-200 rounded-[2.5rem] overflow-hidden bg-white shadow-2xl ring-1 ring-black/[0.02]">
                        <table className="w-full text-xs text-start">
                                 ...
                                 return (
                                   <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                                      ...
                                      <td className="p-4 text-center">
                                         <button type="button" onClick={() => setFormData({...formData, defaultMilestones: formData.defaultMilestones?.filter((_, i) => i !== idx)})} className="text-rose-300 hover:text-rose-600 transition-colors hover:scale-110"><Trash2 className="h-5 w-5" /></button>
                                      </td>
                                   </tr>
                                 );
                              })}
                           ...
                           <tfoot className="bg-slate-50 border-t-8 border-primary">
                              <tr>
                                 <td colSpan={5} className="p-10 text-start">
