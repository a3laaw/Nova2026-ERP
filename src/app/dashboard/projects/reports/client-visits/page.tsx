      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="text-start">
           <h1 className="text-3xl font-black font-headline flex items-center gap-3 text-slate-900">
             ...
             {isRtl ? 'سجل تفاعل العملاء والزيارات' : 'Client Visit Dossier'}
           </h1>
            ...
            {!selectedClientId ? (
              ...
              <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                 ...
                 <div className="space-y-8 relative ps-8">
                    ...
                    {visitsData.length === 0 ? (
                      <div className="py-20 text-center text-slate-400 font-bold italic">{isRtl ? 'لا يوجد زيارات مكتملة مسجلة لهذا العميل.' : 'No completed visits.'}</div>
                               ...
                               <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                     {visit.achievements.length > 0 ? visit.achievements.map((ex: any, i: number) => (
                                       ...
                                       <div className="col-span-full py-4 text-center text-[10px] font-bold text-slate-300 italic">{isRtl ? 'لم يتم تسجيل كميات.' : 'No quantities logged.'}</div>
                                     )}
                                  </div>
                               </div>
                               ...
                               <div className="space-y-4 pt-4 border-t border-slate-50">
                                  ...
                                  <div className="space-y-3">
                                     {visit.comments.length > 0 ? visit.comments.map((c: any, i: number) => (
                                       ...
                                       <div className="py-4 text-center text-[10px] font-bold text-slate-300 italic">{isRtl ? 'لا يوجد ملاحظات.' : 'No notes logged.'}</div>
                                     )}
                                  </div>
                               </div>
                            </CardContent>
