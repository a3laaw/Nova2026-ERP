...
import { 
  ...
  History, Wallet, Landmark, Sparkles
} from "lucide-react";
    ...
    >
      <CardHeader className="p-8 pb-4 text-start">
         ...
         <div className="flex justify-between items-start">
            ...
            {badge && <Badge className="bg-primary/10 text-primary border-0 font-black text-[8px] h-5">{badge}</Badge>}
         </div>
  ...
  return (
    <div className="space-y-8 w-full animate-in fade-in" dir={dir}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
         ...
         {canSeePayroll && (
           <ModuleCard 
              title={tSafe('payroll', 'محرك الرواتب', 'Payroll Engine')}
              desc={isRtl ? "مزامنة البصمة (XLSX)، توليد كشوف الرواتب، والمراجعة المالية." : "Sync attendance, generate payroll, and financial review."}
              icon={Calculator}
         ...
         <ModuleCard 
            title={tSafe('reports', 'مركز التقارير', 'HR Analytics')}
