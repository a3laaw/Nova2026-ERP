      ...
      {error ? (
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
             {[
               { label: t('hr.reports.totalLogs'), val: stats.total, color: 'text-slate-900' },
               { label: t('hr.reports.present'), val: stats.present, color: 'text-emerald-600' },
               { label: t('hr.reports.late'), val: stats.late, color: 'text-amber-600' },
               { label: t('hr.reports.totalLateMins'), val: stats.totalLateMins, color: 'text-rose-600' },
             ].map((s, i) => (
              ...
              <Table>
                <TableHeader className="bg-slate-50 border-b">
                  <TableRow>
                    ...
                    <TableHead className="text-center">{t('hr.basic')}</TableHead>
                    <TableHead className="text-center">{t('hr.deductions')}</TableHead>
                    <TableHead className="text-start pe-8">{t('common.status')}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {loading ? (
