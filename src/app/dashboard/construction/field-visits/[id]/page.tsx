...
export default function FieldVisitDetailsPage() {
  ...
  return (
    <div className="space-y-6 w-full max-w-7xl mx-auto pb-20 animate-in fade-in duration-500 bg-[#fdfaf3] text-start" dir={dir}>
      ...
      <PrintWrapper title={t('construction.fieldProgressStatement')}>
         <div className="space-y-10 text-start">
            ...
            <Tabs defaultValue="progress" className="w-full">
               <TabsList className="bg-white border-2 border-slate-100 rounded-2xl h-14 p-1.5 gap-2 shadow-sm mb-6 inline-flex print:hidden">
                  <TabsTrigger value="progress" className="rounded-xl px-10 font-black text-xs data-[state=active]:bg-primary data-[state=active]:text-white transition-all gap-2 h-full">
                     <Hammer className="h-4 w-4" /> {t('construction.technicalProgress')}
                  </TabsTrigger>
                  <TabsTrigger value="resources" className="rounded-xl px-10 font-black text-xs data-[state=active]:bg-primary data-[state=active]:text-white transition-all gap-2 h-full">
                     <Users className="h-4 w-4" /> {isRtl ? 'الموارد والمعدات' : 'Resources & Equipment'}
                  </TabsTrigger>
               </TabsList>

               <TabsContent value="progress" className="animate-in fade-in duration-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                     <Card className="border-0 shadow-xl rounded-[2.5rem] bg-white overflow-hidden">
                        <CardHeader className="bg-slate-50 border-b p-6 text-start">
                           <CardTitle className="text-sm font-black flex items-center gap-3"><Users className="h-5 w-5 text-primary" /> {isRtl ? 'الموارد البشرية' : 'Human Resources'}</CardTitle>
                        </CardHeader>
                     ...
                     <Card className="border-0 shadow-xl rounded-[2.5rem] bg-white overflow-hidden">
                        <CardHeader className="bg-slate-50 border-b p-6 text-start">
                           <CardTitle className="text-sm font-black flex items-center gap-3"><Truck className="h-5 w-5 text-primary" /> {isRtl ? 'المعدات والآليات' : 'Heavy Equipment'}</CardTitle>
                        </CardHeader>
                        <CardContent className="p-6">
                           <div className="grid grid-cols-1 gap-3">
