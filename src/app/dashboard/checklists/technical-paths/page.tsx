  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => { setActivityForm({ name: '', nameEn: '' }); setIsActOpen(true); }} className="rounded-xl shadow-lg"><Plus className="me-2 h-4 w-4" /> {isRtl ? 'نشاط جديد' : 'New Activity'}</Button>
      </div>
