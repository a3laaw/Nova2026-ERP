...
export type ClientStatus = 'prospective' | 'registered' | 'contracted' | 'inactive';
...
export interface Client extends BaseReference {
  ...
  status: ClientStatus;       // حالة العميل
...
export interface ClientHistory extends BaseReference {
  clientId: string;
  type: 'status_change' | 'note_added' | 'engineer_assigned' | 'system_log' | 'transaction_created';
