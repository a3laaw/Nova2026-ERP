  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex w-full", // Ensure flex for headers
        head_cell: "text-muted-foreground rounded-md w-9 font-black text-[0.7rem] uppercase flex-1 text-center py-2", // Spaced out for Arabic names
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-bold aria-selected:opacity-100 rounded-lg hover:bg-primary/10 hover:text-primary transition-all"
        ),
