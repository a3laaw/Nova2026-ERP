...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'equipment.description': 'إدارة سجل الأصول والمعدات المملوكة والمستأجرة ومتابعة حركتها المالية.',
    'equipment.addNew': 'إضافة أصل جديد',
    'equipment.registerNew': 'تسجيل أصل تشغيلي جديد',
    'equipment.registerNewDesc': 'إدراج معدة مملوكة أو مستأجرة وتحديد مسارها المالي وتكاليف تشغيلها.',
    'equipment.editDetails': 'تعديل بيانات الأصل',
    'equipment.table.code': 'المعدة / الكود',
    'equipment.table.ownership': 'نوع الملكية',
    'equipment.table.rate': 'التعرفة',
    'equipment.form.identity': 'بيانات الأصل المرجعية',
    'equipment.form.code': 'كود المعدة',
    'equipment.form.name': 'اسم المعدة / الماركة',
    'equipment.form.isOwned': 'معدة مملوكة؟',
    'equipment.form.financials': 'المعطيات المالية للإهلاك والإيجار',
    'equipment.form.purchasePrice': 'سعر الشراء الإجمالي',
    'equipment.form.salvageValue': 'القيمة التخريدية المتوقعة',
    'equipment.form.hourlyRate': 'تعرفة الساعة (د.ك)',
    'equipment.form.supplier': 'المورد المؤجر المعتمد',
    'equipment.form.rentalRate': 'القيمة الإيجارية بالساعة (د.ك)',
  ...
  en: {
    ...
    'equipment.description': 'Manage owned and rented equipment, track operational costs and status.',
    'equipment.addNew': 'Add New Asset',
    'equipment.registerNew': 'Register New Asset',
    'equipment.registerNewDesc': 'Enroll owned or rented equipment and define financial parameters.',
    'equipment.editDetails': 'Edit Asset Details',
    'equipment.table.code': 'Asset / Code',
    'equipment.table.ownership': 'Ownership',
    'equipment.table.rate': 'Rate',
    'equipment.form.identity': 'Asset Identity',
    'equipment.form.code': 'Equipment Code',
    'equipment.form.name': 'Equipment Name / Brand',
    'equipment.form.isOwned': 'Owned Asset?',
    'equipment.form.financials': 'Financial & Operational Metrics',
    'equipment.form.purchasePrice': 'Purchase Price',
    'equipment.form.salvageValue': 'Salvage Value',
    'equipment.form.hourlyRate': 'Hourly Rate (KWD)',
    'equipment.form.supplier': 'Rental Supplier',
    'equipment.form.rentalRate': 'Hourly Rental Rate (KWD)',
