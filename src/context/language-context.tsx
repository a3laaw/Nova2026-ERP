...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    generalWorkingHours: 'ساعات العمل العامة',
    ...
    smartDetectHint: 'النظام ذكي! سيقوم بمقارنة بصمة الموظف بأقرب وقت دخول (صباحي أو مسائي) لتحديد التأخير الفعلي تلقائياً.',
    Sunday: 'الأحد',
    Monday: 'الاثنين',
    Tuesday: 'الثلاثاء',
    Wednesday: 'الأربعاء',
  ...
  en: {
    ...
    hireDate: 'Hire Date',
    workHours: 'Schedules',
    workHoursDesc: 'Manage shifts, schedules, and public/weekly holidays.',
    generalWorkingHours: 'General Working Hours',
    architecturalWorkingHours: 'Architectural Working Hours',
    morningShift: 'Morning Shift (Primary)',
    eveningShift: 'Evening Shift (Optional)',
    ...
    smartDetectHint: 'Smart detection! System compares check-ins to nearest period start.',
    Sunday: 'Sunday',
    Monday: 'Monday',
    Tuesday: 'Tuesday',
    Wednesday: 'Wednesday',
